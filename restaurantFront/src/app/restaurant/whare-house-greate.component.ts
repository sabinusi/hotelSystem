...
@Component({
  selector: 'app-whare-house-greate',
  template: `
  <div class="container-fluid">
    <p><b style="color: blue;font-size: 20px">WhareHouseIngredients</b> </p>
    <div class="row">
      <div class="col-md-8">
...
export class WhareHouseGreateComponent implements OnInit {
   ...
   public rows:Array<any> = [];
    public columns:Array<any> = [
      ...
      {title: 'Available',  name: 'available'},
  ...
  private showSave:boolean=false;
    ...
    public ngOnInit():void {
      ...
      this.service.ListIncredientsInWhareHouse().subscribe(
  ...
  this.router.navigateByUrl('/settings/(w:Wharehouse/(e:edit/'+data.row['name']+'))')
