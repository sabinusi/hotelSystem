...
@Component({
  ...
  template: `
  <div class="row">
      <div class="col-md-4"><b style="color: blue;font-size: 20px">Store Report</b></div>
      <!-- from area -->
      <div class="col-md-3">
    ...
    max-height: 420px; overflow: auto;background-image: url('./assets/bac.png');">
    <div style="background-color: white;">
   <div class="row">
     <div class="col-md-4">
       <input *ngIf="config.filtering" placeholder="Search Itncredient"
...
export class StoreReportComponent implements OnInit {
  public rows:Array<any> = [];
    ...
    public ngOnInit():void {
      this.service.storeReport().subscribe(
    ...
    view(){
      ...
      this.data=[]
        this.length=this.data.length;
                 this.onChangeTable(this.config);
      this.service.viewStoreReportBasedOnDate(start,end).subscribe(
            (resp)=>resp.forEach(item=>{
            var   d=new Date(item.date)
