...
@Component({
  ...
  template: `
     ...
     <div class="row">
       <div class="col-md-12">
        <p style="margin-top: 2px;color: blue;font-size: 20px;">Products</p>
        <!-- open row -->
        <div class="row">
          <!-- button area -->
        ...
        <div class="col-md-12 "  *ngFor="let item of product | filterBy: productFilter,let i=index">
            ...
            <div class="row smallForm" >
              ...
              <div class="col-md-4">
                  ...
                  <div class="row ">
                    <div class="col-md-4" >
                      <h4 style="color: #278fc4"><i>Price</i>: </h4>
                      <h4 style="color: #278fc4"><i>Category</i>:</h4>
                    </div>
                    <div class="col-md-8">
                      <h4><b>{{item.price}}</b>  /= </h4>
                      <h4><b>{{item.category}}</b> </h4>
                    </div>
                  </div>
              ...
              <div class="col-md-5" style="height: 100%;overflow-y: auto;">
                  ...
                  <div  class="col-md-12" *ngFor="let item of item.increadients,let p=index">
               ...
               <div class="col-md-2">
                  Number
                 <input class="form-control" [(ngModel)]="bind[i]" type="number">
                 <br><br>

                 <button class="btn btn-success" (click)="save(i)" style="width: 80px;">save</button>
...
private done=[]
  ...
  create(){
  this.router.navigateByUrl('/settings/(p:products/(c:create))')
}
edit(i){
  var name=document.getElementById(i).innerHTML
  this.router.navigateByUrl('/settings/(p:products/(e:edit/'+name+'))')
}
...
save(p){
 ...
 //  console.log(this.incredient)
  this.service.ListNumberIncredient(pname).subscribe(
    resp1=>{
      
      if (resp1.increadients.length !== 0) {
        for (var i = 0; i < resp1.increadients.length; ++i) {
       var name=document.getElementById(p+','+i).innerHTML
               ...
               if (this.bind[p]==undefined) {
                 this.msg.error('please fill all number of product in  '+pname)
                 return
               }
               this.service.UpdateAvailableNumber(pname,this.bind[p]).subscribe(
                 resp=>{})
               ...
               this.service.getMeasurableUnitOfIncredient(name).subscribe(
                 ...
                 resp=>{
                   if (i == resp1.increadients.length) {
                     this.done[p]="true"
                     this.pService.done()
